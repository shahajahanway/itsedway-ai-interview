...
function Interview({ params }) {
    ...
    const [webCamEnabled, setWebCamEnabled] = useState(false);  // Initialize with false to control webcam state

    // Ensure the useEffect runs when params.interviewId changes
    useEffect(() => {
        console.log(params.interviewId);  // Check interviewId in console
        GetInterviewDetails();
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                ...
                <div className='flex flex-col my-5 gap-5'>
                    ...
                    <div className='p-5 border rounded-lg border-yellow-300 bg-yellow-100'>
                        ...
                        <h2 className='mt-3 text-yellow-500'>{process.env.NEXT_PUBLIC_INTERVIEW}</h2>
                    </div>
                </div>
                <div>
                    {webCamEnabled ? (
